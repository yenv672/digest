...
public class gvrGrowingCircle : MonoBehaviour, IGvrGazePointer
{
    ...
    public float reticleInnerAngle = 0.0f;
    // Current outer angle of the reticle (in degrees).
    public float reticleOuterAngle = 0.5f;
    // Current distance of the reticle (in meters).
    public float reticleDistanceInMeters = 10.0f;
