Shader "SecondChance/ClipShader"
{
	Properties 
	{
...
_RimColor("Rim Light Color", Color) = (0.9720278,0,1,1)
_RimPower("Rim Light Power", Range(0.1,3) ) = 3
_SpecularColor("Spec Color", Color) = (1,1,1,1)
_clipMask("Clip Mask", 2D) = "black" {}
_clipEdgeColor("Clip Edge Color", Color) = (1,0,0,1)
_clipDistance("Clip Amount", Range(-1,1.01) ) = 0.4
_clipEdgeDistance("Clip Edge Thickness", Range(0,1) ) = 0.2
...
float4 Multiply3=Step0 * Multiply0;
float4 Add2=Multiply2 + Multiply3;
